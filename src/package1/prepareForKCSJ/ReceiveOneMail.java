...
public class ReceiveOneMail {
	...
	public static void main(String args[]) throws Exception {
		...
		String smtpServerAddress = "smtp.qq.com";
		String pop3ServerAddress = "pop.qq.com";
		String userName = "1079139460@qq.com";
		String password = "103110506";
		
		smtpServerAddress = "smtp.163.com";
		pop3ServerAddress = "pop.163.com";
		userName = "18080922587@163.com";
		password = "wocao123";
	...
	private static void saveNewMail(Message[] message, ReceiveOneMail pmm, int i) throws MessagingException, Exception {
	...
	private void saveMail(Message[] message, ReceiveOneMail pmm, int i) throws MessagingException, Exception {
	...
	public static void setFilePathPrefix(String filePathPrefix) {
		ReceiveOneMail.filePathPrefix = filePathPrefix;
	}
}